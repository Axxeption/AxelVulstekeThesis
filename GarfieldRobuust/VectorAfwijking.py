...
printName = "TrainLR0001VectorDeviation10"
vectorDeviation = 1
#button object
class Button:
    x = 0
...
with tf.Session() as sess:
    ...
    r = [1]
    r[0] = 0
    writer = tf.summary.FileWriter("/home/axel/Documents/TensorFlowLog/CheckButton/"+printName)
            ...
            if(buttonList != None):
                ...
                if d[0]:
                    ...
                    if(num_episode%1 == 0):
                        ...
                        print(rAll)
                        plotter(rewardList)
                        np.savetxt('Train/currentRewardDeviation10.txt', rewardList, fmt='%.2f', delimiter=',',
                                   header="Result with standard deviation 10")
