...
def plotter(x):
    ...
    plt.title('Progress of RL with pen and home')
    plt.plot(x)
    plt.savefig('NoTrainOtherWords.png')
...
with tf.Session() as sess:
    ...
    r = [1]
    r[0] = 0
    writer = tf.summary.FileWriter("/home/axel/Documents/TensorFlowLog/CheckButton/1Layer-0Test")
    writer.add_graph(sess.graph)
    if (saved):
        print("Restore model and network! ")
            ...
            if(buttonList != None):
                ...
                if d[0]:
                    ...
                    if(num_episode%2 == 0):
                        ...
                        print(rAll)
                        plotter(rewardList)
                        np.savetxt('noTrainCurrentRewardOtherWords.txt', rewardList, fmt='%.2f', delimiter=',',
                                   header="Result with home and pen without train")
